...
import { Dummy, SnsPublisher, SnsSubscriber } from '@functions'
...
import { SnsPubSub } from '@stateMachines/machines'
...
const serverlessConfiguration: CustomServerless = {
  ...
  custom: {
    ...
    stepFunctionsLocal: {
      ...
      TaskResourceMapping: {
        ...SnsPubSub.stateChain.getTaskToResourceMap(),
      },
    },
    dynamodb: {
      stages: ['offline'],
  ...
  resources: {
    Resources: {
      [SnsTopicSuper.name]: SnsTopicSuper.spec,
    },
  },
  functions: {
